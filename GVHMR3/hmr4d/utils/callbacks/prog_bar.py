...
MainStore.store(name="prog_reporter_every0.02", node=prog_reporter_base(log_every_percent=0.02), group=group_name)
MainStore.store(name="prog_reporter_every0.01", node=prog_reporter_base(log_every_percent=0.01), group=group_name)
